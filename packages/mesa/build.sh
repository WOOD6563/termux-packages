...
TERMUX_PKG_VERSION="25.2.6"
_LLVM_MAJOR_VERSION=$(. $TERMUX_SCRIPTDIR/packages/libllvm/build.sh; echo "${LLVM_MAJOR_VERSION}")
_LLVM_MAJOR_VERSION_NEXT=$((_LLVM_MAJOR_VERSION + 1))
TERMUX_PKG_SRCURL=https://archive.mesa3d.org/mesa-${TERMUX_PKG_VERSION}.tar.xz
TERMUX_PKG_SHA256=361c97e8afa5fe20141c5362c5b489040751e12861c186a16c621a2fb182fc42
...
termux_step_pre_configure() {
	...
	TERMUX_PKG_EXTRA_CONFIGURE_ARGS+=" -Dvulkan-drivers=disabled -Dgallium-rusticl=false -Dopencl=false -Dgallium-opencl=false"
